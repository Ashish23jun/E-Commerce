			...
			<div class="modal-content">
				<form action="categories" method="post">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLongTitl">Add New Category</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body text-center">
						<input type="text" name="categoryname" class="form-control" id="name" required="required"
				...
				<td>
					...
					<button type="button" class="btn btn-warning" data-toggle="modal"
							...
							onclick="document.getElementById('updateCategoryName').value = '${category.name}';
									document.getElementById('updateCategoryId').value = ${category.id};">Update
					</button>
				</td>
			</tr>
		</c:forEach>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<form action="categories/update" method="post">
					...
					<div class="modal-body text-center">
						<input class="form-control" type="hidden" name="categoryid" id="updateCategoryId" value="0">
						<div class="form-group">
							<input class="form-control" type="text" name="categoryname" id="updateCategoryName" value="">
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
